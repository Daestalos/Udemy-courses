...
window.addEventListener('DOMContentLoaded', ()=>{
    ...
    // создадим объект для показа сообщений при различных ситуациях с запросом
    const message = {
    ...
    // Присваиваем каждой форме на странице функцию отправки данных
    forms.forEach(item => {
        postData(item);
    });
    ...
    function postData(form){
        ...
        form.addEventListener('submit', (e)=>{
            ...
            // зададим стиль нашему спинеру
            statusMessage.style.cssText = `
                display: block;
                margin: 0 auto;
            `;
            // statusMessage.textContent = message.loading;
            // размещаем на форме наш текст
    ...
    function showThanksModal(message) {
        ...
        // скрываем модальное окно для отображения
        ...
        // размещаем модальное окно на странице
